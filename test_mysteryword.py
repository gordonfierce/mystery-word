...
def test_word_length_selector():
    a_short_word = mw.word_length_selector(4, 6)
    assert len(a_short_word) > 3 and len(a_short_word) < 7
    a_medium_word = mw.word_length_selector(6, 10)
    assert len(a_medium_word) > 5 and len(a_medium_word) < 11
    a_long_word = mw.word_length_selector(10)
    assert len(a_long_word) > 9
